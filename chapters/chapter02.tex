...
\begin{figure}[p]
\begin{center}
\subfloat[A collection of SMD Components.]{
\label{fig:smd1}
...
\subfloat[A board containing THT and SMD Components.]{
\label{fig:THT_SMD}
...
\begin{figure}[p]
\begin{center}
\subfloat[A dipiction of Lora compared to other networks.]{
\label{fig:smd1}
...
\subfloat[A linear frequency modulated upchirp in the time domain.]{
\label{fig:css}
