\section{Design of a 16 bit Central Processing Unit (CPU)} 
...
\begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width = \textwidth]{G0}
...
\begin{sidewaysfigure}[p]
    \centering
    \includegraphics[scale=0.575]{schma_dcu}
...
\begin{figure}[p]
\includegraphics[scale = 0.3]{sysarch}
\centering
